...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(197, 69);
			...
			this->label1->Size = System::Drawing::Size(197, 31);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Nhập từ viêt tắt: ";
			this->label1->Click += gcnew System::EventHandler(this, &Search1::label1_Click);
			// 
			// textBox1
			// 
			...
			this->listBox1->Location = System::Drawing::Point(18, 115);
			this->listBox1->Name = L"listBox1";
			this->listBox1->Size = System::Drawing::Size(245, 121);
			...
			this->Text = L"Tìm theo từ viết tắt";
