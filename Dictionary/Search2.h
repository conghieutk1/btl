...
namespace Dictionary {
	...
	/// Summary for Search2
	/// </summary>
	public ref class Search2 : public System::Windows::Forms::Form
	{
	public:
		Search2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(233, 23);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Nhập nghĩa của từ viết tắt: ";
			// 
			// textBox1
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(197, 57);
			...
			this->listBox1->Location = System::Drawing::Point(23, 106);
			this->listBox1->Name = L"listBox1";
			this->listBox1->Size = System::Drawing::Size(242, 134);
